...
describe('should return error with invalid markdown formatting', () => {
  /* eslint-disable indent, no-unexpected-multiline */
  it.each
  `
    ...
    ${'Unclosed Emphasis Asterisk across multiple lines'}   | ${'Emphasize with *asterisks\nacross* lines.'}
    ${'Unclosed Emphasis Underscore across multiple lines'} | ${'Emphasize with _underscores\nacross_ lines.'}
    ${'Unclosed Strong Asterisk across multiple lines'}     | ${'Strengthen with **asterisks\nacross** lines.'}
    ${'Unclosed Strong Underscore across multiple lines'}   | ${'Strengthen with __underscores\nacross__ lines.'}
  `
  ('$description: $inputText',
  ({inputText}) => {
    const parserResults = parseText(inputText);
