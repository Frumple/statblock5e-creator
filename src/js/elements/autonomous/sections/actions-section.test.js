...
it('section should have default blocks', () => {
  ...
  sharedSpecs.sectionShouldHaveDefaultBlocks(actionsSection, [block]);
});

describe('and the default "Club" attack action is removed, allowing these specs to run starting with no actions', () => {
  beforeEach(() => {
