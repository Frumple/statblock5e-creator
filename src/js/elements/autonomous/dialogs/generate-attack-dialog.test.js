...
describe('when the generate attack dialog is opened', () => {
  ...
  describe('and the dialog is submitted with melee checked, it should add a new action block for a melee weapon', () => {
    ...
    `
      ...
      ${'melee weapon'}                                     | ${false}  | ${false}    | ${false} | ${'*Melee Weapon Attack:* mod[str + prof] to hit, reach 10 ft., one target. *Hit:* dmg[1d8 + str] slashing damage.'}                                                                                          | ${'<em>Melee Weapon Attack:</em> +3 to hit, reach 10 ft., one target. <em>Hit:</em> 5 (1d8 + 1) slashing damage.'}
      ${'melee versatile weapon'}                           | ${false}  | ${true}     | ${false} | ${'*Melee Weapon Attack:* mod[str + prof] to hit, reach 10 ft., one target. *Hit:* dmg[1d8 + str] slashing damage, or dmg[1d10 + str] slashing damage if used with two hands.'}                            | ${'<em>Melee Weapon Attack:</em> +3 to hit, reach 10 ft., one target. <em>Hit:</em> 5 (1d8 + 1) slashing damage, or 6 (1d10 + 1) slashing damage if used with two hands.'}
      ${'melee weapon with bonus damage'}                   | ${false}  | ${false}    | ${true}  | ${'*Melee Weapon Attack:* mod[str + prof] to hit, reach 10 ft., one target. *Hit:* dmg[1d8 + str] slashing damage plus dmg[2d6] fire damage.'}                                                                | ${'<em>Melee Weapon Attack:</em> +3 to hit, reach 10 ft., one target. <em>Hit:</em> 5 (1d8 + 1) slashing damage plus 7 (2d6) fire damage.'}
      ${'melee versatile weapon with bonus damage'}         | ${false}  | ${true}     | ${true}  | ${'*Melee Weapon Attack:* mod[str + prof] to hit, reach 10 ft., one target. *Hit:* dmg[1d8 + str] slashing damage, or dmg[1d10 + str] slashing damage if used with two hands, plus dmg[2d6] fire damage.'} | ${'<em>Melee Weapon Attack:</em> +3 to hit, reach 10 ft., one target. <em>Hit:</em> 5 (1d8 + 1) slashing damage, or 6 (1d10 + 1) slashing damage if used with two hands, plus 7 (2d6) fire damage.'}
      ${'melee finesse weapon'}                             | ${true}   | ${false}    | ${false} | ${'*Melee Weapon Attack:* mod[fin + prof] to hit, reach 10 ft., one target. *Hit:* dmg[1d8 + fin] slashing damage.'}                                                                                          | ${'<em>Melee Weapon Attack:</em> +6 to hit, reach 10 ft., one target. <em>Hit:</em> 8 (1d8 + 4) slashing damage.'}
      ${'melee finesse versatile weapon'}                   | ${true}   | ${true}     | ${false} | ${'*Melee Weapon Attack:* mod[fin + prof] to hit, reach 10 ft., one target. *Hit:* dmg[1d8 + fin] slashing damage, or dmg[1d10 + fin] slashing damage if used with two hands.'}                            | ${'<em>Melee Weapon Attack:</em> +6 to hit, reach 10 ft., one target. <em>Hit:</em> 8 (1d8 + 4) slashing damage, or 9 (1d10 + 4) slashing damage if used with two hands.'}
      ${'melee finesse weapon with bonus damage'}           | ${true}   | ${false}    | ${true}  | ${'*Melee Weapon Attack:* mod[fin + prof] to hit, reach 10 ft., one target. *Hit:* dmg[1d8 + fin] slashing damage plus dmg[2d6] fire damage.'}                                                                | ${'<em>Melee Weapon Attack:</em> +6 to hit, reach 10 ft., one target. <em>Hit:</em> 8 (1d8 + 4) slashing damage plus 7 (2d6) fire damage.'}
      ${'melee finesse versatile weapon with bonus damage'} | ${true}   | ${true}     | ${true}  | ${'*Melee Weapon Attack:* mod[fin + prof] to hit, reach 10 ft., one target. *Hit:* dmg[1d8 + fin] slashing damage, or dmg[1d10 + fin] slashing damage if used with two hands, plus dmg[2d6] fire damage.'} | ${'<em>Melee Weapon Attack:</em> +6 to hit, reach 10 ft., one target. <em>Hit:</em> 8 (1d8 + 4) slashing damage, or 9 (1d10 + 4) slashing damage if used with two hands, plus 7 (2d6) fire damage.'}
    `
  ...
  describe('and the dialog is submitted with ranged checked, it should add a new action block for a ranged weapon', () => {
    ...
    it.each
      `
      description                                            | isFinesse | isVersatile | hasBonus | generatedText                                                                                                                                                                                                               | renderedText
      ${'ranged weapon'}                                     | ${false}  | ${false}    | ${false} | ${'*Ranged Weapon Attack:* mod[dex + prof] to hit, range 30/120 ft., one target. *Hit:* dmg[2d10 + dex] piercing damage.'}                                                                                            | ${'<em>Ranged Weapon Attack:</em> +5 to hit, range 30/120 ft., one target. <em>Hit:</em> 13 (2d10 + 2) piercing damage.'}
      ${'ranged versatile weapon'}                           | ${false}  | ${true}     | ${false} | ${'*Ranged Weapon Attack:* mod[dex + prof] to hit, range 30/120 ft., one target. *Hit:* dmg[2d10 + dex] piercing damage, or dmg[2d12 + dex] piercing damage if used with two hands.'}                              | ${'<em>Ranged Weapon Attack:</em> +5 to hit, range 30/120 ft., one target. <em>Hit:</em> 13 (2d10 + 2) piercing damage, or 15 (2d12 + 2) piercing damage if used with two hands.'}
      ${'ranged weapon with bonus damage'}                   | ${false}  | ${false}    | ${true}  | ${'*Ranged Weapon Attack:* mod[dex + prof] to hit, range 30/120 ft., one target. *Hit:* dmg[2d10 + dex] piercing damage plus dmg[4d4] poison damage.'}                                                                | ${'<em>Ranged Weapon Attack:</em> +5 to hit, range 30/120 ft., one target. <em>Hit:</em> 13 (2d10 + 2) piercing damage plus 10 (4d4) poison damage.'}
      ${'ranged versatile weapon with bonus damage'}         | ${false}  | ${true}     | ${true}  | ${'*Ranged Weapon Attack:* mod[dex + prof] to hit, range 30/120 ft., one target. *Hit:* dmg[2d10 + dex] piercing damage, or dmg[2d12 + dex] piercing damage if used with two hands, plus dmg[4d4] poison damage.'} | ${'<em>Ranged Weapon Attack:</em> +5 to hit, range 30/120 ft., one target. <em>Hit:</em> 13 (2d10 + 2) piercing damage, or 15 (2d12 + 2) piercing damage if used with two hands, plus 10 (4d4) poison damage.'}
      ${'ranged finesse weapon'}                             | ${true}   | ${false}    | ${false} | ${'*Ranged Weapon Attack:* mod[fin + prof] to hit, range 30/120 ft., one target. *Hit:* dmg[2d10 + fin] piercing damage.'}                                                                                            | ${'<em>Ranged Weapon Attack:</em> +8 to hit, range 30/120 ft., one target. <em>Hit:</em> 16 (2d10 + 5) piercing damage.'}
      ${'ranged finesse versatile weapon'}                   | ${true}   | ${true}     | ${false} | ${'*Ranged Weapon Attack:* mod[fin + prof] to hit, range 30/120 ft., one target. *Hit:* dmg[2d10 + fin] piercing damage, or dmg[2d12 + fin] piercing damage if used with two hands.'}                              | ${'<em>Ranged Weapon Attack:</em> +8 to hit, range 30/120 ft., one target. <em>Hit:</em> 16 (2d10 + 5) piercing damage, or 18 (2d12 + 5) piercing damage if used with two hands.'}
      ${'ranged finesse weapon with bonus damage'}           | ${true}   | ${false}    | ${true}  | ${'*Ranged Weapon Attack:* mod[fin + prof] to hit, range 30/120 ft., one target. *Hit:* dmg[2d10 + fin] piercing damage plus dmg[4d4] poison damage.'}                                                                | ${'<em>Ranged Weapon Attack:</em> +8 to hit, range 30/120 ft., one target. <em>Hit:</em> 16 (2d10 + 5) piercing damage plus 10 (4d4) poison damage.'}
      ${'ranged finesse versatile weapon with bonus damage'} | ${true}   | ${true}     | ${true}  | ${'*Ranged Weapon Attack:* mod[fin + prof] to hit, range 30/120 ft., one target. *Hit:* dmg[2d10 + fin] piercing damage, or dmg[2d12 + fin] piercing damage if used with two hands, plus dmg[4d4] poison damage.'} | ${'<em>Ranged Weapon Attack:</em> +8 to hit, range 30/120 ft., one target. <em>Hit:</em> 16 (2d10 + 5) piercing damage, or 18 (2d12 + 5) piercing damage if used with two hands, plus 10 (4d4) poison damage.'}
    `
    ('$description: {isFinesse="$isFinesse", isVersatile="$isVersatile", hasBonus="$hasBonus"} => {generatedText="$generatedText", renderedText="$renderedText"}',
    ({isFinesse, isVersatile, hasBonus, generatedText, renderedText}) => {
  ...
  describe('and the dialog is submitted with melee and checked both checked, it should add a new action block for a combined melee/ranged weapon', () => {
    ...
    it.each
      ...
      ${'melee/ranged (equal damage) weapon'}                                       | ${2}             | ${6}         | ${2}              | ${6}          | ${false}  | ${false}    | ${false} | ${'*Melee or Ranged Weapon Attack:* mod[str + prof] to hit, reach 5 ft. or range 20/60 ft., one target. *Hit:* dmg[2d6 + str] piercing damage.'}                                                                                                                                                                              | ${'<em>Melee or Ranged Weapon Attack:</em> +6 to hit, reach 5 ft. or range 20/60 ft., one target. <em>Hit:</em> 9 (2d6 + 2) piercing damage.'}
      ${'melee/ranged (equal damage) versatile weapon'}                             | ${2}             | ${6}         | ${2}              | ${6}          | ${false}  | ${true}     | ${false} | ${'*Melee or Ranged Weapon Attack:* mod[str + prof] to hit, reach 5 ft. or range 20/60 ft., one target. *Hit:* dmg[2d6 + str] piercing damage, or dmg[2d10 + str] piercing damage if used with two hands to make a melee attack.'}                                                                                         | ${'<em>Melee or Ranged Weapon Attack:</em> +6 to hit, reach 5 ft. or range 20/60 ft., one target. <em>Hit:</em> 9 (2d6 + 2) piercing damage, or 13 (2d10 + 2) piercing damage if used with two hands to make a melee attack.'}
      ${'melee/ranged (equal damage) weapon with bonus damage'}                     | ${2}             | ${6}         | ${2}              | ${6}          | ${false}  | ${false}    | ${true}  | ${'*Melee or Ranged Weapon Attack:* mod[str + prof] to hit, reach 5 ft. or range 20/60 ft., one target. *Hit:* dmg[2d6 + str] piercing damage plus dmg[1d12] lightning damage.'}                                                                                                                                              | ${'<em>Melee or Ranged Weapon Attack:</em> +6 to hit, reach 5 ft. or range 20/60 ft., one target. <em>Hit:</em> 9 (2d6 + 2) piercing damage plus 6 (1d12) lightning damage.'}
      ${'melee/ranged (equal damage) versatile weapon with bonus damage'}           | ${2}             | ${6}         | ${2}              | ${6}          | ${false}  | ${true}     | ${true}  | ${'*Melee or Ranged Weapon Attack:* mod[str + prof] to hit, reach 5 ft. or range 20/60 ft., one target. *Hit:* dmg[2d6 + str] piercing damage, or dmg[2d10 + str] piercing damage if used with two hands to make a melee attack, plus dmg[1d12] lightning damage.'}                                                        | ${'<em>Melee or Ranged Weapon Attack:</em> +6 to hit, reach 5 ft. or range 20/60 ft., one target. <em>Hit:</em> 9 (2d6 + 2) piercing damage, or 13 (2d10 + 2) piercing damage if used with two hands to make a melee attack, plus 6 (1d12) lightning damage.'}
      ${'melee/ranged (equal damage) finesse weapon'}                               | ${2}             | ${6}         | ${2}              | ${6}          | ${true}   | ${false}    | ${false} | ${'*Melee or Ranged Weapon Attack:* mod[fin + prof] to hit, reach 5 ft. or range 20/60 ft., one target. *Hit:* dmg[2d6 + fin] piercing damage.'}                                                                                                                                                                              | ${'<em>Melee or Ranged Weapon Attack:</em> +7 to hit, reach 5 ft. or range 20/60 ft., one target. <em>Hit:</em> 10 (2d6 + 3) piercing damage.'}
      ...
      ${'melee/ranged (equal damage) finesse weapon with bonus damage'}             | ${2}             | ${6}         | ${2}              | ${6}          | ${true}   | ${false}    | ${true}  | ${'*Melee or Ranged Weapon Attack:* mod[fin + prof] to hit, reach 5 ft. or range 20/60 ft., one target. *Hit:* dmg[2d6 + fin] piercing damage plus dmg[1d12] lightning damage.'}                                                                                                                                              | ${'<em>Melee or Ranged Weapon Attack:</em> +7 to hit, reach 5 ft. or range 20/60 ft., one target. <em>Hit:</em> 10 (2d6 + 3) piercing damage plus 6 (1d12) lightning damage.'}
      ${'melee/ranged (equal damage) finesse versatile weapon with bonus damage'}   | ${2}             | ${6}         | ${2}              | ${6}          | ${true}   | ${true}     | ${true}  | ${'*Melee or Ranged Weapon Attack:* mod[fin + prof] to hit, reach 5 ft. or range 20/60 ft., one target. *Hit:* dmg[2d6 + fin] piercing damage, or dmg[2d10 + fin] piercing damage if used with two hands to make a melee attack, plus dmg[1d12] lightning damage.'}                                                        | ${'<em>Melee or Ranged Weapon Attack:</em> +7 to hit, reach 5 ft. or range 20/60 ft., one target. <em>Hit:</em> 10 (2d6 + 3) piercing damage, or 14 (2d10 + 3) piercing damage if used with two hands to make a melee attack, plus 6 (1d12) lightning damage.'}
      ${'melee/ranged (unequal damage) weapon'}                                     | ${2}             | ${6}         | ${1}              | ${8}          | ${false}  | ${false}    | ${false} | ${'*Melee or Ranged Weapon Attack:* mod[str + prof] to hit, reach 5 ft. or range 20/60 ft., one target. *Hit:* dmg[2d6 + str] piercing damage in melee or dmg[1d8 + str] piercing damage at range.'}                                                                                                                       | ${'<em>Melee or Ranged Weapon Attack:</em> +6 to hit, reach 5 ft. or range 20/60 ft., one target. <em>Hit:</em> 9 (2d6 + 2) piercing damage in melee or 6 (1d8 + 2) piercing damage at range.'}
      ${'melee/ranged (unequal damage) versatile weapon'}                           | ${2}             | ${6}         | ${1}              | ${8}          | ${false}  | ${true}     | ${false} | ${'*Melee or Ranged Weapon Attack:* mod[str + prof] to hit, reach 5 ft. or range 20/60 ft., one target. *Hit:* dmg[2d6 + str] piercing damage in melee or dmg[1d8 + str] piercing damage at range, or dmg[2d10 + str] piercing damage if used with two hands to make a melee attack.'}                                  | ${'<em>Melee or Ranged Weapon Attack:</em> +6 to hit, reach 5 ft. or range 20/60 ft., one target. <em>Hit:</em> 9 (2d6 + 2) piercing damage in melee or 6 (1d8 + 2) piercing damage at range, or 13 (2d10 + 2) piercing damage if used with two hands to make a melee attack.'}
      ${'melee/ranged (unequal damage) weapon with bonus damage'}                   | ${2}             | ${6}         | ${1}              | ${8}          | ${false}  | ${false}    | ${true}  | ${'*Melee or Ranged Weapon Attack:* mod[str + prof] to hit, reach 5 ft. or range 20/60 ft., one target. *Hit:* dmg[2d6 + str] piercing damage in melee or dmg[1d8 + str] piercing damage at range, plus dmg[1d12] lightning damage.'}                                                                                      | ${'<em>Melee or Ranged Weapon Attack:</em> +6 to hit, reach 5 ft. or range 20/60 ft., one target. <em>Hit:</em> 9 (2d6 + 2) piercing damage in melee or 6 (1d8 + 2) piercing damage at range, plus 6 (1d12) lightning damage.'}
      ${'melee/ranged (unequal damage) versatile weapon with bonus damage'}         | ${2}             | ${6}         | ${1}              | ${8}          | ${false}  | ${true}     | ${true}  | ${'*Melee or Ranged Weapon Attack:* mod[str + prof] to hit, reach 5 ft. or range 20/60 ft., one target. *Hit:* dmg[2d6 + str] piercing damage in melee or dmg[1d8 + str] piercing damage at range, or dmg[2d10 + str] piercing damage if used with two hands to make a melee attack, plus dmg[1d12] lightning damage.'} | ${'<em>Melee or Ranged Weapon Attack:</em> +6 to hit, reach 5 ft. or range 20/60 ft., one target. <em>Hit:</em> 9 (2d6 + 2) piercing damage in melee or 6 (1d8 + 2) piercing damage at range, or 13 (2d10 + 2) piercing damage if used with two hands to make a melee attack, plus 6 (1d12) lightning damage.'}
      ...
      ${'melee/ranged (unequal damage) finesse weapon with bonus damage'}           | ${2}             | ${6}         | ${1}              | ${8}          | ${true}   | ${false}    | ${true}  | ${'*Melee or Ranged Weapon Attack:* mod[fin + prof] to hit, reach 5 ft. or range 20/60 ft., one target. *Hit:* dmg[2d6 + fin] piercing damage in melee or dmg[1d8 + fin] piercing damage at range, plus dmg[1d12] lightning damage.'}                                                                                      | ${'<em>Melee or Ranged Weapon Attack:</em> +7 to hit, reach 5 ft. or range 20/60 ft., one target. <em>Hit:</em> 10 (2d6 + 3) piercing damage in melee or 7 (1d8 + 3) piercing damage at range, plus 6 (1d12) lightning damage.'}
      ${'melee/ranged (unequal damage) finesse versatile weapon with bonus damage'} | ${2}             | ${6}         | ${1}              | ${8}          | ${true}   | ${true}     | ${true}  | ${'*Melee or Ranged Weapon Attack:* mod[fin + prof] to hit, reach 5 ft. or range 20/60 ft., one target. *Hit:* dmg[2d6 + fin] piercing damage in melee or dmg[1d8 + fin] piercing damage at range, or dmg[2d10 + fin] piercing damage if used with two hands to make a melee attack, plus dmg[1d12] lightning damage.'} | ${'<em>Melee or Ranged Weapon Attack:</em> +7 to hit, reach 5 ft. or range 20/60 ft., one target. <em>Hit:</em> 10 (2d6 + 3) piercing damage in melee or 7 (1d8 + 3) piercing damage at range, or 14 (2d10 + 3) piercing damage if used with two hands to make a melee attack, plus 6 (1d12) lightning damage.'}
    `
    ('$description: {isFinesse="$isFinesse", isVersatile="$isVersatile", hasBonus="$hasBonus"} => {generatedText="$generatedText", renderedText="$renderedText"}',
  ...
  describe('and the dialog is submitted with damage die sizes of 1, it should add a new action block for a weapon that deals a specific amount of damage', () => {
    ...
    `
      ...
      ${'weapon dealing 1 damage'}  | ${1}              | ${'*Melee Weapon Attack:* mod[str + prof] to hit, reach 5 ft., one target. *Hit:* 1 slashing damage.'}  | ${'<em>Melee Weapon Attack:</em> +4 to hit, reach 5 ft., one target. <em>Hit:</em> 1 slashing damage.'}
      ${'weapon dealing 25 damage'} | ${25}             | ${'*Melee Weapon Attack:* mod[str + prof] to hit, reach 5 ft., one target. *Hit:* 25 slashing damage.'} | ${'<em>Melee Weapon Attack:</em> +4 to hit, reach 5 ft., one target. <em>Hit:</em> 25 slashing damage.'}
    `
  ...
  describe('and a predefined weapon is entered, it should auto-fill the dialog fields and add a new action block for that weapon', () => {
    ...
    `
      ...
      ${'Club'}           | ${false}  | ${5}   | ${''}       | ${''}     | ${'bludgeoning'} | ${true}      | ${1}                   | ${4}               | ${false}      | ${''}                   | ${''}               | ${false}         | ${''}                      | ${''}                  | ${'*Melee Weapon Attack:* mod[str + prof] to hit, reach 5 ft., one target. *Hit:* dmg[1d4 + str] bludgeoning damage.'}                                                                                                               | ${'<em>Melee Weapon Attack:</em> +5 to hit, reach 5 ft., one target. <em>Hit:</em> 5 (1d4 + 3) bludgeoning damage.'}
      ${'Dagger'}         | ${true}   | ${5}   | ${20}       | ${60}     | ${'piercing'}    | ${true}      | ${1}                   | ${4}               | ${true}       | ${1}                    | ${4}                | ${false}         | ${''}                      | ${''}                  | ${'*Melee or Ranged Weapon Attack:* mod[fin + prof] to hit, reach 5 ft. or range 20/60 ft., one target. *Hit:* dmg[1d4 + fin] piercing damage.'}                                                                                     | ${'<em>Melee or Ranged Weapon Attack:</em> +6 to hit, reach 5 ft. or range 20/60 ft., one target. <em>Hit:</em> 6 (1d4 + 4) piercing damage.'}
      ${'Greatclub'}      | ${false}  | ${5}   | ${''}       | ${''}     | ${'bludgeoning'} | ${true}      | ${1}                   | ${8}               | ${false}      | ${''}                   | ${''}               | ${false}         | ${''}                      | ${''}                  | ${'*Melee Weapon Attack:* mod[str + prof] to hit, reach 5 ft., one target. *Hit:* dmg[1d8 + str] bludgeoning damage.'}                                                                                                               | ${'<em>Melee Weapon Attack:</em> +5 to hit, reach 5 ft., one target. <em>Hit:</em> 7 (1d8 + 3) bludgeoning damage.'}
      ${'Handaxe'}        | ${false}  | ${5}   | ${20}       | ${60}     | ${'slashing'}    | ${true}      | ${1}                   | ${6}               | ${true}       | ${1}                    | ${6}                | ${false}         | ${''}                      | ${''}                  | ${'*Melee or Ranged Weapon Attack:* mod[str + prof] to hit, reach 5 ft. or range 20/60 ft., one target. *Hit:* dmg[1d6 + str] slashing damage.'}                                                                                     | ${'<em>Melee or Ranged Weapon Attack:</em> +5 to hit, reach 5 ft. or range 20/60 ft., one target. <em>Hit:</em> 6 (1d6 + 3) slashing damage.'}
      ${'Javelin'}        | ${false}  | ${5}   | ${30}       | ${120}    | ${'piercing'}    | ${true}      | ${1}                   | ${6}               | ${true}       | ${1}                    | ${6}                | ${false}         | ${''}                      | ${''}                  | ${'*Melee or Ranged Weapon Attack:* mod[str + prof] to hit, reach 5 ft. or range 30/120 ft., one target. *Hit:* dmg[1d6 + str] piercing damage.'}                                                                                    | ${'<em>Melee or Ranged Weapon Attack:</em> +5 to hit, reach 5 ft. or range 30/120 ft., one target. <em>Hit:</em> 6 (1d6 + 3) piercing damage.'}
      ${'Light Hammer'}   | ${false}  | ${5}   | ${20}       | ${60}     | ${'bludgeoning'} | ${true}      | ${1}                   | ${4}               | ${true}       | ${1}                    | ${4}                | ${false}         | ${''}                      | ${''}                  | ${'*Melee or Ranged Weapon Attack:* mod[str + prof] to hit, reach 5 ft. or range 20/60 ft., one target. *Hit:* dmg[1d4 + str] bludgeoning damage.'}                                                                                  | ${'<em>Melee or Ranged Weapon Attack:</em> +5 to hit, reach 5 ft. or range 20/60 ft., one target. <em>Hit:</em> 5 (1d4 + 3) bludgeoning damage.'}
      ${'Mace'}           | ${false}  | ${5}   | ${''}       | ${''}     | ${'bludgeoning'} | ${true}      | ${1}                   | ${6}               | ${false}      | ${''}                   | ${''}               | ${false}         | ${''}                      | ${''}                  | ${'*Melee Weapon Attack:* mod[str + prof] to hit, reach 5 ft., one target. *Hit:* dmg[1d6 + str] bludgeoning damage.'}                                                                                                               | ${'<em>Melee Weapon Attack:</em> +5 to hit, reach 5 ft., one target. <em>Hit:</em> 6 (1d6 + 3) bludgeoning damage.'}
      ${'Quarterstaff'}   | ${false}  | ${5}   | ${''}       | ${''}     | ${'bludgeoning'} | ${true}      | ${1}                   | ${6}               | ${false}      | ${''}                   | ${''}               | ${true}          | ${1}                       | ${8}                   | ${'*Melee Weapon Attack:* mod[str + prof] to hit, reach 5 ft., one target. *Hit:* dmg[1d6 + str] bludgeoning damage, or dmg[1d8 + str] bludgeoning damage if used with two hands.'}                                               | ${'<em>Melee Weapon Attack:</em> +5 to hit, reach 5 ft., one target. <em>Hit:</em> 6 (1d6 + 3) bludgeoning damage, or 7 (1d8 + 3) bludgeoning damage if used with two hands.'}
      ${'Sickle'}         | ${false}  | ${5}   | ${''}       | ${''}     | ${'slashing'}    | ${true}      | ${1}                   | ${4}               | ${false}      | ${''}                   | ${''}               | ${false}         | ${''}                      | ${''}                  | ${'*Melee Weapon Attack:* mod[str + prof] to hit, reach 5 ft., one target. *Hit:* dmg[1d4 + str] slashing damage.'}                                                                                                                  | ${'<em>Melee Weapon Attack:</em> +5 to hit, reach 5 ft., one target. <em>Hit:</em> 5 (1d4 + 3) slashing damage.'}
      ${'Spear'}          | ${false}  | ${5}   | ${20}       | ${60}     | ${'piercing'}    | ${true}      | ${1}                   | ${6}               | ${true}       | ${1}                    | ${6}                | ${true}          | ${1}                       | ${8}                   | ${'*Melee or Ranged Weapon Attack:* mod[str + prof] to hit, reach 5 ft. or range 20/60 ft., one target. *Hit:* dmg[1d6 + str] piercing damage, or dmg[1d8 + str] piercing damage if used with two hands to make a melee attack.'} | ${'<em>Melee or Ranged Weapon Attack:</em> +5 to hit, reach 5 ft. or range 20/60 ft., one target. <em>Hit:</em> 6 (1d6 + 3) piercing damage, or 7 (1d8 + 3) piercing damage if used with two hands to make a melee attack.'}
      ${'Light Crossbow'} | ${false}  | ${''}  | ${80}       | ${320}    | ${'piercing'}    | ${false}     | ${''}                  | ${''}              | ${true}       | ${1}                    | ${8}                | ${false}         | ${''}                      | ${''}                  | ${'*Ranged Weapon Attack:* mod[dex + prof] to hit, range 80/320 ft., one target. *Hit:* dmg[1d8 + dex] piercing damage.'}                                                                                                            | ${'<em>Ranged Weapon Attack:</em> +5 to hit, range 80/320 ft., one target. <em>Hit:</em> 7 (1d8 + 3) piercing damage.'}
      ${'Dart'}           | ${true}   | ${''}  | ${20}       | ${60}     | ${'piercing'}    | ${false}     | ${''}                  | ${''}              | ${true}       | ${1}                    | ${4}                | ${false}         | ${''}                      | ${''}                  | ${'*Ranged Weapon Attack:* mod[fin + prof] to hit, range 20/60 ft., one target. *Hit:* dmg[1d4 + fin] piercing damage.'}                                                                                                             | ${'<em>Ranged Weapon Attack:</em> +6 to hit, range 20/60 ft., one target. <em>Hit:</em> 6 (1d4 + 4) piercing damage.'}
      ${'Shortbow'}       | ${false}  | ${''}  | ${80}       | ${320}    | ${'piercing'}    | ${false}     | ${''}                  | ${''}              | ${true}       | ${1}                    | ${6}                | ${false}         | ${''}                      | ${''}                  | ${'*Ranged Weapon Attack:* mod[dex + prof] to hit, range 80/320 ft., one target. *Hit:* dmg[1d6 + dex] piercing damage.'}                                                                                                            | ${'<em>Ranged Weapon Attack:</em> +5 to hit, range 80/320 ft., one target. <em>Hit:</em> 6 (1d6 + 3) piercing damage.'}
      ${'Sling'}          | ${false}  | ${''}  | ${30}       | ${120}    | ${'bludgeoning'} | ${false}     | ${''}                  | ${''}              | ${true}       | ${1}                    | ${4}                | ${false}         | ${''}                      | ${''}                  | ${'*Ranged Weapon Attack:* mod[dex + prof] to hit, range 30/120 ft., one target. *Hit:* dmg[1d4 + dex] bludgeoning damage.'}                                                                                                         | ${'<em>Ranged Weapon Attack:</em> +5 to hit, range 30/120 ft., one target. <em>Hit:</em> 5 (1d4 + 3) bludgeoning damage.'}
      ${'Battleaxe'}      | ${false}  | ${5}   | ${''}       | ${''}     | ${'slashing'}    | ${true}      | ${1}                   | ${8}               | ${false}      | ${''}                   | ${''}               | ${true}          | ${1}                       | ${10}                  | ${'*Melee Weapon Attack:* mod[str + prof] to hit, reach 5 ft., one target. *Hit:* dmg[1d8 + str] slashing damage, or dmg[1d10 + str] slashing damage if used with two hands.'}                                                    | ${'<em>Melee Weapon Attack:</em> +5 to hit, reach 5 ft., one target. <em>Hit:</em> 7 (1d8 + 3) slashing damage, or 8 (1d10 + 3) slashing damage if used with two hands.'}
      ${'Flail'}          | ${false}  | ${5}   | ${''}       | ${''}     | ${'bludgeoning'} | ${true}      | ${1}                   | ${8}               | ${false}      | ${''}                   | ${''}               | ${false}         | ${''}                      | ${''}                  | ${'*Melee Weapon Attack:* mod[str + prof] to hit, reach 5 ft., one target. *Hit:* dmg[1d8 + str] bludgeoning damage.'}                                                                                                               | ${'<em>Melee Weapon Attack:</em> +5 to hit, reach 5 ft., one target. <em>Hit:</em> 7 (1d8 + 3) bludgeoning damage.'}
      ${'Glaive'}         | ${false}  | ${10}  | ${''}       | ${''}     | ${'slashing'}    | ${true}      | ${1}                   | ${10}              | ${false}      | ${''}                   | ${''}               | ${false}         | ${''}                      | ${''}                  | ${'*Melee Weapon Attack:* mod[str + prof] to hit, reach 10 ft., one target. *Hit:* dmg[1d10 + str] slashing damage.'}                                                                                                                | ${'<em>Melee Weapon Attack:</em> +5 to hit, reach 10 ft., one target. <em>Hit:</em> 8 (1d10 + 3) slashing damage.'}
      ${'Greataxe'}       | ${false}  | ${5}   | ${''}       | ${''}     | ${'slashing'}    | ${true}      | ${1}                   | ${12}              | ${false}      | ${''}                   | ${''}               | ${false}         | ${''}                      | ${''}                  | ${'*Melee Weapon Attack:* mod[str + prof] to hit, reach 5 ft., one target. *Hit:* dmg[1d12 + str] slashing damage.'}                                                                                                                 | ${'<em>Melee Weapon Attack:</em> +5 to hit, reach 5 ft., one target. <em>Hit:</em> 9 (1d12 + 3) slashing damage.'}
      ${'Greatsword'}     | ${false}  | ${5}   | ${''}       | ${''}     | ${'slashing'}    | ${true}      | ${2}                   | ${6}               | ${false}      | ${''}                   | ${''}               | ${false}         | ${''}                      | ${''}                  | ${'*Melee Weapon Attack:* mod[str + prof] to hit, reach 5 ft., one target. *Hit:* dmg[2d6 + str] slashing damage.'}                                                                                                                  | ${'<em>Melee Weapon Attack:</em> +5 to hit, reach 5 ft., one target. <em>Hit:</em> 10 (2d6 + 3) slashing damage.'}
      ${'Halberd'}        | ${false}  | ${10}  | ${''}       | ${''}     | ${'slashing'}    | ${true}      | ${1}                   | ${10}              | ${false}      | ${''}                   | ${''}               | ${false}         | ${''}                      | ${''}                  | ${'*Melee Weapon Attack:* mod[str + prof] to hit, reach 10 ft., one target. *Hit:* dmg[1d10 + str] slashing damage.'}                                                                                                                | ${'<em>Melee Weapon Attack:</em> +5 to hit, reach 10 ft., one target. <em>Hit:</em> 8 (1d10 + 3) slashing damage.'}
      ${'Lance'}          | ${false}  | ${10}  | ${''}       | ${''}     | ${'piercing'}    | ${true}      | ${1}                   | ${12}              | ${false}      | ${''}                   | ${''}               | ${false}         | ${''}                      | ${''}                  | ${'*Melee Weapon Attack:* mod[str + prof] to hit, reach 10 ft., one target. *Hit:* dmg[1d12 + str] piercing damage.'}                                                                                                                | ${'<em>Melee Weapon Attack:</em> +5 to hit, reach 10 ft., one target. <em>Hit:</em> 9 (1d12 + 3) piercing damage.'}
      ${'Longsword'}      | ${false}  | ${5}   | ${''}       | ${''}     | ${'slashing'}    | ${true}      | ${1}                   | ${8}               | ${false}      | ${''}                   | ${''}               | ${true}          | ${1}                       | ${10}                  | ${'*Melee Weapon Attack:* mod[str + prof] to hit, reach 5 ft., one target. *Hit:* dmg[1d8 + str] slashing damage, or dmg[1d10 + str] slashing damage if used with two hands.'}                                                    | ${'<em>Melee Weapon Attack:</em> +5 to hit, reach 5 ft., one target. <em>Hit:</em> 7 (1d8 + 3) slashing damage, or 8 (1d10 + 3) slashing damage if used with two hands.'}
      ${'Maul'}           | ${false}  | ${5}   | ${''}       | ${''}     | ${'bludgeoning'} | ${true}      | ${2}                   | ${6}               | ${false}      | ${''}                   | ${''}               | ${false}         | ${''}                      | ${''}                  | ${'*Melee Weapon Attack:* mod[str + prof] to hit, reach 5 ft., one target. *Hit:* dmg[2d6 + str] bludgeoning damage.'}                                                                                                               | ${'<em>Melee Weapon Attack:</em> +5 to hit, reach 5 ft., one target. <em>Hit:</em> 10 (2d6 + 3) bludgeoning damage.'}
      ${'Morningstar'}    | ${false}  | ${5}   | ${''}       | ${''}     | ${'piercing'}    | ${true}      | ${1}                   | ${8}               | ${false}      | ${''}                   | ${''}               | ${false}         | ${''}                      | ${''}                  | ${'*Melee Weapon Attack:* mod[str + prof] to hit, reach 5 ft., one target. *Hit:* dmg[1d8 + str] piercing damage.'}                                                                                                                  | ${'<em>Melee Weapon Attack:</em> +5 to hit, reach 5 ft., one target. <em>Hit:</em> 7 (1d8 + 3) piercing damage.'}
      ${'Pike'}           | ${false}  | ${10}  | ${''}       | ${''}     | ${'piercing'}    | ${true}      | ${1}                   | ${10}              | ${false}      | ${''}                   | ${''}               | ${false}         | ${''}                      | ${''}                  | ${'*Melee Weapon Attack:* mod[str + prof] to hit, reach 10 ft., one target. *Hit:* dmg[1d10 + str] piercing damage.'}                                                                                                                | ${'<em>Melee Weapon Attack:</em> +5 to hit, reach 10 ft., one target. <em>Hit:</em> 8 (1d10 + 3) piercing damage.'}
      ${'Rapier'}         | ${true}   | ${5}   | ${''}       | ${''}     | ${'piercing'}    | ${true}      | ${1}                   | ${8}               | ${false}      | ${''}                   | ${''}               | ${false}         | ${''}                      | ${''}                  | ${'*Melee Weapon Attack:* mod[fin + prof] to hit, reach 5 ft., one target. *Hit:* dmg[1d8 + fin] piercing damage.'}                                                                                                                  | ${'<em>Melee Weapon Attack:</em> +6 to hit, reach 5 ft., one target. <em>Hit:</em> 8 (1d8 + 4) piercing damage.'}
      ${'Scimitar'}       | ${true}   | ${5}   | ${''}       | ${''}     | ${'slashing'}    | ${true}      | ${1}                   | ${6}               | ${false}      | ${''}                   | ${''}               | ${false}         | ${''}                      | ${''}                  | ${'*Melee Weapon Attack:* mod[fin + prof] to hit, reach 5 ft., one target. *Hit:* dmg[1d6 + fin] slashing damage.'}                                                                                                                  | ${'<em>Melee Weapon Attack:</em> +6 to hit, reach 5 ft., one target. <em>Hit:</em> 7 (1d6 + 4) slashing damage.'}
      ${'Shortsword'}     | ${true}   | ${5}   | ${''}       | ${''}     | ${'piercing'}    | ${true}      | ${1}                   | ${6}               | ${false}      | ${''}                   | ${''}               | ${false}         | ${''}                      | ${''}                  | ${'*Melee Weapon Attack:* mod[fin + prof] to hit, reach 5 ft., one target. *Hit:* dmg[1d6 + fin] piercing damage.'}                                                                                                                  | ${'<em>Melee Weapon Attack:</em> +6 to hit, reach 5 ft., one target. <em>Hit:</em> 7 (1d6 + 4) piercing damage.'}
      ${'Trident'}        | ${false}  | ${5}   | ${20}       | ${60}     | ${'piercing'}    | ${true}      | ${1}                   | ${6}               | ${true}       | ${1}                    | ${6}                | ${true}          | ${1}                       | ${8}                   | ${'*Melee or Ranged Weapon Attack:* mod[str + prof] to hit, reach 5 ft. or range 20/60 ft., one target. *Hit:* dmg[1d6 + str] piercing damage, or dmg[1d8 + str] piercing damage if used with two hands to make a melee attack.'} | ${'<em>Melee or Ranged Weapon Attack:</em> +5 to hit, reach 5 ft. or range 20/60 ft., one target. <em>Hit:</em> 6 (1d6 + 3) piercing damage, or 7 (1d8 + 3) piercing damage if used with two hands to make a melee attack.'}
      ${'War Pick'}       | ${false}  | ${5}   | ${''}       | ${''}     | ${'piercing'}    | ${true}      | ${1}                   | ${8}               | ${false}      | ${''}                   | ${''}               | ${false}         | ${''}                      | ${''}                  | ${'*Melee Weapon Attack:* mod[str + prof] to hit, reach 5 ft., one target. *Hit:* dmg[1d8 + str] piercing damage.'}                                                                                                                  | ${'<em>Melee Weapon Attack:</em> +5 to hit, reach 5 ft., one target. <em>Hit:</em> 7 (1d8 + 3) piercing damage.'}
      ${'Warhammer'}      | ${false}  | ${5}   | ${''}       | ${''}     | ${'bludgeoning'} | ${true}      | ${1}                   | ${8}               | ${false}      | ${''}                   | ${''}               | ${true}          | ${1}                       | ${10}                  | ${'*Melee Weapon Attack:* mod[str + prof] to hit, reach 5 ft., one target. *Hit:* dmg[1d8 + str] bludgeoning damage, or dmg[1d10 + str] bludgeoning damage if used with two hands.'}                                              | ${'<em>Melee Weapon Attack:</em> +5 to hit, reach 5 ft., one target. <em>Hit:</em> 7 (1d8 + 3) bludgeoning damage, or 8 (1d10 + 3) bludgeoning damage if used with two hands.'}
      ${'Whip'}           | ${true}   | ${10}  | ${''}       | ${''}     | ${'slashing'}    | ${true}      | ${1}                   | ${4}               | ${false}      | ${''}                   | ${''}               | ${false}         | ${''}                      | ${''}                  | ${'*Melee Weapon Attack:* mod[fin + prof] to hit, reach 10 ft., one target. *Hit:* dmg[1d4 + fin] slashing damage.'}                                                                                                                 | ${'<em>Melee Weapon Attack:</em> +6 to hit, reach 10 ft., one target. <em>Hit:</em> 6 (1d4 + 4) slashing damage.'}
      ${'Blowgun'}        | ${false}  | ${''}  | ${25}       | ${100}    | ${'piercing'}    | ${false}     | ${''}                  | ${''}              | ${true}       | ${1}                    | ${1}                | ${false}         | ${''}                      | ${''}                  | ${'*Ranged Weapon Attack:* mod[dex + prof] to hit, range 25/100 ft., one target. *Hit:* 1 piercing damage.'}                                                                                                                            | ${'<em>Ranged Weapon Attack:</em> +5 to hit, range 25/100 ft., one target. <em>Hit:</em> 1 piercing damage.'}
      ${'Hand Crossbow'}  | ${false}  | ${''}  | ${30}       | ${120}    | ${'piercing'}    | ${false}     | ${''}                  | ${''}              | ${true}       | ${1}                    | ${6}                | ${false}         | ${''}                      | ${''}                  | ${'*Ranged Weapon Attack:* mod[dex + prof] to hit, range 30/120 ft., one target. *Hit:* dmg[1d6 + dex] piercing damage.'}                                                                                                            | ${'<em>Ranged Weapon Attack:</em> +5 to hit, range 30/120 ft., one target. <em>Hit:</em> 6 (1d6 + 3) piercing damage.'}
      ${'Heavy Crossbow'} | ${false}  | ${''}  | ${100}      | ${400}    | ${'piercing'}    | ${false}     | ${''}                  | ${''}              | ${true}       | ${1}                    | ${10}               | ${false}         | ${''}                      | ${''}                  | ${'*Ranged Weapon Attack:* mod[dex + prof] to hit, range 100/400 ft., one target. *Hit:* dmg[1d10 + dex] piercing damage.'}                                                                                                          | ${'<em>Ranged Weapon Attack:</em> +5 to hit, range 100/400 ft., one target. <em>Hit:</em> 8 (1d10 + 3) piercing damage.'}
      ${'Longbow'}        | ${false}  | ${''}  | ${150}      | ${600}    | ${'piercing'}    | ${false}     | ${''}                  | ${''}              | ${true}       | ${1}                    | ${8}                | ${false}         | ${''}                      | ${''}                  | ${'*Ranged Weapon Attack:* mod[dex + prof] to hit, range 150/600 ft., one target. *Hit:* dmg[1d8 + dex] piercing damage.'}                                                                                                           | ${'<em>Ranged Weapon Attack:</em> +5 to hit, range 150/600 ft., one target. <em>Hit:</em> 7 (1d8 + 3) piercing damage.'}
    `
...
function verifyDialogControlsResetToDefaults() {
  const expectedGeneratedText = '*Melee Weapon Attack:* mod[str + prof] to hit, reach 5 ft., one target. *Hit:* dmg[1d8 + str] damage.';
