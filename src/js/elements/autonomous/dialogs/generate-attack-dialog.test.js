...
describe('when the generate attack dialog is opened', () => {
  ...
  describe('and a predefined weapon is entered, it should auto-fill the dialog fields and add a new action block for that weapon', () => {
    ...
    `
      ...
      ${'Club'}           | ${false}  | ${5}   | ${''}       | ${''}     | ${'bludgeoning'} | ${true}      | ${1}                   | ${4}               | ${false}      | ${''}                   | ${''}               | ${false}         | ${''}                      | ${''}                  | ${'*Melee Weapon Attack:* mod[strmod + prof] to hit, reach 5 ft., one target. *Hit:* dmg[1d4 + strmod] bludgeoning damage.'}                                                                                                               | ${'<em>Melee Weapon Attack:</em> +5 to hit, reach 5 ft., one target. <em>Hit:</em> 5 (1d4 + 3) bludgeoning damage.'}
      ${'Dagger'}         | ${true}   | ${5}   | ${20}       | ${60}     | ${'piercing'}    | ${true}      | ${1}                   | ${4}               | ${true}       | ${1}                    | ${4}                | ${false}         | ${''}                      | ${''}                  | ${'*Melee or Ranged Weapon Attack:* mod[finmod + prof] to hit, reach 5 ft. or range 20/60 ft., one target. *Hit:* dmg[1d4 + finmod] piercing damage.'}                                                                                     | ${'<em>Melee or Ranged Weapon Attack:</em> +6 to hit, reach 5 ft. or range 20/60 ft., one target. <em>Hit:</em> 6 (1d4 + 4) piercing damage.'}
      ${'Greatclub'}      | ${false}  | ${5}   | ${''}       | ${''}     | ${'bludgeoning'} | ${true}      | ${1}                   | ${8}               | ${false}      | ${''}                   | ${''}               | ${false}         | ${''}                      | ${''}                  | ${'*Melee Weapon Attack:* mod[strmod + prof] to hit, reach 5 ft., one target. *Hit:* dmg[1d8 + strmod] bludgeoning damage.'}                                                                                                               | ${'<em>Melee Weapon Attack:</em> +5 to hit, reach 5 ft., one target. <em>Hit:</em> 7 (1d8 + 3) bludgeoning damage.'}
      ${'Handaxe'}        | ${false}  | ${5}   | ${20}       | ${60}     | ${'slashing'}    | ${true}      | ${1}                   | ${6}               | ${true}       | ${1}                    | ${6}                | ${false}         | ${''}                      | ${''}                  | ${'*Melee or Ranged Weapon Attack:* mod[strmod + prof] to hit, reach 5 ft. or range 20/60 ft., one target. *Hit:* dmg[1d6 + strmod] slashing damage.'}                                                                                     | ${'<em>Melee or Ranged Weapon Attack:</em> +5 to hit, reach 5 ft. or range 20/60 ft., one target. <em>Hit:</em> 6 (1d6 + 3) slashing damage.'}
      ${'Javelin'}        | ${false}  | ${5}   | ${30}       | ${120}    | ${'piercing'}    | ${true}      | ${1}                   | ${6}               | ${true}       | ${1}                    | ${6}                | ${false}         | ${''}                      | ${''}                  | ${'*Melee or Ranged Weapon Attack:* mod[strmod + prof] to hit, reach 5 ft. or range 30/120 ft., one target. *Hit:* dmg[1d6 + strmod] piercing damage.'}                                                                                    | ${'<em>Melee or Ranged Weapon Attack:</em> +5 to hit, reach 5 ft. or range 30/120 ft., one target. <em>Hit:</em> 6 (1d6 + 3) piercing damage.'}
      ...
      ${'Mace'}           | ${false}  | ${5}   | ${''}       | ${''}     | ${'bludgeoning'} | ${true}      | ${1}                   | ${6}               | ${false}      | ${''}                   | ${''}               | ${false}         | ${''}                      | ${''}                  | ${'*Melee Weapon Attack:* mod[strmod + prof] to hit, reach 5 ft., one target. *Hit:* dmg[1d6 + strmod] bludgeoning damage.'}                                                                                                               | ${'<em>Melee Weapon Attack:</em> +5 to hit, reach 5 ft., one target. <em>Hit:</em> 6 (1d6 + 3) bludgeoning damage.'}
      ${'Quarterstaff'}   | ${false}  | ${5}   | ${''}       | ${''}     | ${'bludgeoning'} | ${true}      | ${1}                   | ${6}               | ${false}      | ${''}                   | ${''}               | ${true}          | ${1}                       | ${8}                   | ${'*Melee Weapon Attack:* mod[strmod + prof] to hit, reach 5 ft., one target. *Hit:* dmg[1d6 + strmod] bludgeoning damage, or dmg[1d8 + strmod] bludgeoning damage if used with two hands.'}                                               | ${'<em>Melee Weapon Attack:</em> +5 to hit, reach 5 ft., one target. <em>Hit:</em> 6 (1d6 + 3) bludgeoning damage, or 7 (1d8 + 3) bludgeoning damage if used with two hands.'}
      ${'Sickle'}         | ${false}  | ${5}   | ${''}       | ${''}     | ${'slashing'}    | ${true}      | ${1}                   | ${4}               | ${false}      | ${''}                   | ${''}               | ${false}         | ${''}                      | ${''}                  | ${'*Melee Weapon Attack:* mod[strmod + prof] to hit, reach 5 ft., one target. *Hit:* dmg[1d4 + strmod] slashing damage.'}                                                                                                                  | ${'<em>Melee Weapon Attack:</em> +5 to hit, reach 5 ft., one target. <em>Hit:</em> 5 (1d4 + 3) slashing damage.'}
      ...
      ${'Light Crossbow'} | ${false}  | ${''}  | ${80}       | ${320}    | ${'piercing'}    | ${false}     | ${''}                  | ${''}              | ${true}       | ${1}                    | ${8}                | ${false}         | ${''}                      | ${''}                  | ${'*Ranged Weapon Attack:* mod[dexmod + prof] to hit, range 80/320 ft., one target. *Hit:* dmg[1d8 + dexmod] piercing damage.'}                                                                                                            | ${'<em>Ranged Weapon Attack:</em> +5 to hit, range 80/320 ft., one target. <em>Hit:</em> 7 (1d8 + 3) piercing damage.'}
      ${'Dart'}           | ${true}   | ${''}  | ${20}       | ${60}     | ${'piercing'}    | ${false}     | ${''}                  | ${''}              | ${true}       | ${1}                    | ${4}                | ${false}         | ${''}                      | ${''}                  | ${'*Ranged Weapon Attack:* mod[finmod + prof] to hit, range 20/60 ft., one target. *Hit:* dmg[1d4 + finmod] piercing damage.'}                                                                                                             | ${'<em>Ranged Weapon Attack:</em> +6 to hit, range 20/60 ft., one target. <em>Hit:</em> 6 (1d4 + 4) piercing damage.'}
      ${'Shortbow'}       | ${false}  | ${''}  | ${80}       | ${320}    | ${'piercing'}    | ${false}     | ${''}                  | ${''}              | ${true}       | ${1}                    | ${6}                | ${false}         | ${''}                      | ${''}                  | ${'*Ranged Weapon Attack:* mod[dexmod + prof] to hit, range 80/320 ft., one target. *Hit:* dmg[1d6 + dexmod] piercing damage.'}                                                                                                            | ${'<em>Ranged Weapon Attack:</em> +5 to hit, range 80/320 ft., one target. <em>Hit:</em> 6 (1d6 + 3) piercing damage.'}
      ${'Sling'}          | ${false}  | ${''}  | ${30}       | ${120}    | ${'bludgeoning'} | ${false}     | ${''}                  | ${''}              | ${true}       | ${1}                    | ${4}                | ${false}         | ${''}                      | ${''}                  | ${'*Ranged Weapon Attack:* mod[dexmod + prof] to hit, range 30/120 ft., one target. *Hit:* dmg[1d4 + dexmod] bludgeoning damage.'}                                                                                                         | ${'<em>Ranged Weapon Attack:</em> +5 to hit, range 30/120 ft., one target. <em>Hit:</em> 5 (1d4 + 3) bludgeoning damage.'}
      ${'Battleaxe'}      | ${false}  | ${5}   | ${''}       | ${''}     | ${'slashing'}    | ${true}      | ${1}                   | ${8}               | ${false}      | ${''}                   | ${''}               | ${true}          | ${1}                       | ${10}                  | ${'*Melee Weapon Attack:* mod[strmod + prof] to hit, reach 5 ft., one target. *Hit:* dmg[1d8 + strmod] slashing damage, or dmg[1d10 + strmod] slashing damage if used with two hands.'}                                                    | ${'<em>Melee Weapon Attack:</em> +5 to hit, reach 5 ft., one target. <em>Hit:</em> 7 (1d8 + 3) slashing damage, or 8 (1d10 + 3) slashing damage if used with two hands.'}
      ${'Flail'}          | ${false}  | ${5}   | ${''}       | ${''}     | ${'bludgeoning'} | ${true}      | ${1}                   | ${8}               | ${false}      | ${''}                   | ${''}               | ${false}         | ${''}                      | ${''}                  | ${'*Melee Weapon Attack:* mod[strmod + prof] to hit, reach 5 ft., one target. *Hit:* dmg[1d8 + strmod] bludgeoning damage.'}                                                                                                               | ${'<em>Melee Weapon Attack:</em> +5 to hit, reach 5 ft., one target. <em>Hit:</em> 7 (1d8 + 3) bludgeoning damage.'}
      ${'Glaive'}         | ${false}  | ${10}  | ${''}       | ${''}     | ${'slashing'}    | ${true}      | ${1}                   | ${10}              | ${false}      | ${''}                   | ${''}               | ${false}         | ${''}                      | ${''}                  | ${'*Melee Weapon Attack:* mod[strmod + prof] to hit, reach 10 ft., one target. *Hit:* dmg[1d10 + strmod] slashing damage.'}                                                                                                                | ${'<em>Melee Weapon Attack:</em> +5 to hit, reach 10 ft., one target. <em>Hit:</em> 8 (1d10 + 3) slashing damage.'}
      ${'Greataxe'}       | ${false}  | ${5}   | ${''}       | ${''}     | ${'slashing'}    | ${true}      | ${1}                   | ${12}              | ${false}      | ${''}                   | ${''}               | ${false}         | ${''}                      | ${''}                  | ${'*Melee Weapon Attack:* mod[strmod + prof] to hit, reach 5 ft., one target. *Hit:* dmg[1d12 + strmod] slashing damage.'}                                                                                                                 | ${'<em>Melee Weapon Attack:</em> +5 to hit, reach 5 ft., one target. <em>Hit:</em> 9 (1d12 + 3) slashing damage.'}
      ${'Greatsword'}     | ${false}  | ${5}   | ${''}       | ${''}     | ${'slashing'}    | ${true}      | ${2}                   | ${6}               | ${false}      | ${''}                   | ${''}               | ${false}         | ${''}                      | ${''}                  | ${'*Melee Weapon Attack:* mod[strmod + prof] to hit, reach 5 ft., one target. *Hit:* dmg[2d6 + strmod] slashing damage.'}                                                                                                                  | ${'<em>Melee Weapon Attack:</em> +5 to hit, reach 5 ft., one target. <em>Hit:</em> 10 (2d6 + 3) slashing damage.'}
      ${'Halberd'}        | ${false}  | ${10}  | ${''}       | ${''}     | ${'slashing'}    | ${true}      | ${1}                   | ${10}              | ${false}      | ${''}                   | ${''}               | ${false}         | ${''}                      | ${''}                  | ${'*Melee Weapon Attack:* mod[strmod + prof] to hit, reach 10 ft., one target. *Hit:* dmg[1d10 + strmod] slashing damage.'}                                                                                                                | ${'<em>Melee Weapon Attack:</em> +5 to hit, reach 10 ft., one target. <em>Hit:</em> 8 (1d10 + 3) slashing damage.'}
      ${'Lance'}          | ${false}  | ${10}  | ${''}       | ${''}     | ${'piercing'}    | ${true}      | ${1}                   | ${12}              | ${false}      | ${''}                   | ${''}               | ${false}         | ${''}                      | ${''}                  | ${'*Melee Weapon Attack:* mod[strmod + prof] to hit, reach 10 ft., one target. *Hit:* dmg[1d12 + strmod] piercing damage.'}                                                                                                                | ${'<em>Melee Weapon Attack:</em> +5 to hit, reach 10 ft., one target. <em>Hit:</em> 9 (1d12 + 3) piercing damage.'}
      ${'Longsword'}      | ${false}  | ${5}   | ${''}       | ${''}     | ${'slashing'}    | ${true}      | ${1}                   | ${8}               | ${false}      | ${''}                   | ${''}               | ${true}          | ${1}                       | ${10}                  | ${'*Melee Weapon Attack:* mod[strmod + prof] to hit, reach 5 ft., one target. *Hit:* dmg[1d8 + strmod] slashing damage, or dmg[1d10 + strmod] slashing damage if used with two hands.'}                                                    | ${'<em>Melee Weapon Attack:</em> +5 to hit, reach 5 ft., one target. <em>Hit:</em> 7 (1d8 + 3) slashing damage, or 8 (1d10 + 3) slashing damage if used with two hands.'}
      ${'Maul'}           | ${false}  | ${5}   | ${''}       | ${''}     | ${'bludgeoning'} | ${true}      | ${2}                   | ${6}               | ${false}      | ${''}                   | ${''}               | ${false}         | ${''}                      | ${''}                  | ${'*Melee Weapon Attack:* mod[strmod + prof] to hit, reach 5 ft., one target. *Hit:* dmg[2d6 + strmod] bludgeoning damage.'}                                                                                                               | ${'<em>Melee Weapon Attack:</em> +5 to hit, reach 5 ft., one target. <em>Hit:</em> 10 (2d6 + 3) bludgeoning damage.'}
      ${'Morningstar'}    | ${false}  | ${5}   | ${''}       | ${''}     | ${'piercing'}    | ${true}      | ${1}                   | ${8}               | ${false}      | ${''}                   | ${''}               | ${false}         | ${''}                      | ${''}                  | ${'*Melee Weapon Attack:* mod[strmod + prof] to hit, reach 5 ft., one target. *Hit:* dmg[1d8 + strmod] piercing damage.'}                                                                                                                  | ${'<em>Melee Weapon Attack:</em> +5 to hit, reach 5 ft., one target. <em>Hit:</em> 7 (1d8 + 3) piercing damage.'}
      ${'Pike'}           | ${false}  | ${10}  | ${''}       | ${''}     | ${'piercing'}    | ${true}      | ${1}                   | ${10}              | ${false}      | ${''}                   | ${''}               | ${false}         | ${''}                      | ${''}                  | ${'*Melee Weapon Attack:* mod[strmod + prof] to hit, reach 10 ft., one target. *Hit:* dmg[1d10 + strmod] piercing damage.'}                                                                                                                | ${'<em>Melee Weapon Attack:</em> +5 to hit, reach 10 ft., one target. <em>Hit:</em> 8 (1d10 + 3) piercing damage.'}
      ${'Rapier'}         | ${true}   | ${5}   | ${''}       | ${''}     | ${'piercing'}    | ${true}      | ${1}                   | ${8}               | ${false}      | ${''}                   | ${''}               | ${false}         | ${''}                      | ${''}                  | ${'*Melee Weapon Attack:* mod[finmod + prof] to hit, reach 5 ft., one target. *Hit:* dmg[1d8 + finmod] piercing damage.'}                                                                                                                  | ${'<em>Melee Weapon Attack:</em> +6 to hit, reach 5 ft., one target. <em>Hit:</em> 8 (1d8 + 4) piercing damage.'}
      ${'Scimitar'}       | ${true}   | ${5}   | ${''}       | ${''}     | ${'slashing'}    | ${true}      | ${1}                   | ${6}               | ${false}      | ${''}                   | ${''}               | ${false}         | ${''}                      | ${''}                  | ${'*Melee Weapon Attack:* mod[finmod + prof] to hit, reach 5 ft., one target. *Hit:* dmg[1d6 + finmod] slashing damage.'}                                                                                                                  | ${'<em>Melee Weapon Attack:</em> +6 to hit, reach 5 ft., one target. <em>Hit:</em> 7 (1d6 + 4) slashing damage.'}
      ${'Shortsword'}     | ${true}   | ${5}   | ${''}       | ${''}     | ${'piercing'}    | ${true}      | ${1}                   | ${6}               | ${false}      | ${''}                   | ${''}               | ${false}         | ${''}                      | ${''}                  | ${'*Melee Weapon Attack:* mod[finmod + prof] to hit, reach 5 ft., one target. *Hit:* dmg[1d6 + finmod] piercing damage.'}                                                                                                                  | ${'<em>Melee Weapon Attack:</em> +6 to hit, reach 5 ft., one target. <em>Hit:</em> 7 (1d6 + 4) piercing damage.'}
      ${'Trident'}        | ${false}  | ${5}   | ${20}       | ${60}     | ${'piercing'}    | ${true}      | ${1}                   | ${6}               | ${true}       | ${1}                    | ${6}                | ${true}          | ${1}                       | ${8}                   | ${'*Melee or Ranged Weapon Attack:* mod[strmod + prof] to hit, reach 5 ft. or range 20/60 ft., one target. *Hit:* dmg[1d6 + strmod] piercing damage, or dmg[1d8 + strmod] piercing damage if used with two hands to make a melee attack.'} | ${'<em>Melee or Ranged Weapon Attack:</em> +5 to hit, reach 5 ft. or range 20/60 ft., one target. <em>Hit:</em> 6 (1d6 + 3) piercing damage, or 7 (1d8 + 3) piercing damage if used with two hands to make a melee attack.'}
      ${'War Pick'}       | ${false}  | ${5}   | ${''}       | ${''}     | ${'piercing'}    | ${true}      | ${1}                   | ${8}               | ${false}      | ${''}                   | ${''}               | ${false}         | ${''}                      | ${''}                  | ${'*Melee Weapon Attack:* mod[strmod + prof] to hit, reach 5 ft., one target. *Hit:* dmg[1d8 + strmod] piercing damage.'}                                                                                                                  | ${'<em>Melee Weapon Attack:</em> +5 to hit, reach 5 ft., one target. <em>Hit:</em> 7 (1d8 + 3) piercing damage.'}
      ${'Warhammer'}      | ${false}  | ${5}   | ${''}       | ${''}     | ${'bludgeoning'} | ${true}      | ${1}                   | ${8}               | ${false}      | ${''}                   | ${''}               | ${true}          | ${1}                       | ${10}                  | ${'*Melee Weapon Attack:* mod[strmod + prof] to hit, reach 5 ft., one target. *Hit:* dmg[1d8 + strmod] bludgeoning damage, or dmg[1d10 + strmod] bludgeoning damage if used with two hands.'}                                              | ${'<em>Melee Weapon Attack:</em> +5 to hit, reach 5 ft., one target. <em>Hit:</em> 7 (1d8 + 3) bludgeoning damage, or 8 (1d10 + 3) bludgeoning damage if used with two hands.'}
      ${'Whip'}           | ${true}   | ${10}  | ${''}       | ${''}     | ${'slashing'}    | ${true}      | ${1}                   | ${4}               | ${false}      | ${''}                   | ${''}               | ${false}         | ${''}                      | ${''}                  | ${'*Melee Weapon Attack:* mod[finmod + prof] to hit, reach 10 ft., one target. *Hit:* dmg[1d4 + finmod] slashing damage.'}                                                                                                                 | ${'<em>Melee Weapon Attack:</em> +6 to hit, reach 10 ft., one target. <em>Hit:</em> 6 (1d4 + 4) slashing damage.'}
      ${'Blowgun'}        | ${false}  | ${''}  | ${25}       | ${100}    | ${'piercing'}    | ${false}     | ${''}                  | ${''}              | ${true}       | ${1}                    | ${1}                | ${false}         | ${''}                      | ${''}                  | ${'*Ranged Weapon Attack:* mod[dexmod + prof] to hit, range 25/100 ft., one target. *Hit:* 1 piercing damage.'}                                                                                                                            | ${'<em>Ranged Weapon Attack:</em> +5 to hit, range 25/100 ft., one target. <em>Hit:</em> 1 piercing damage.'}
      ${'Hand Crossbow'}  | ${false}  | ${''}  | ${30}       | ${120}    | ${'piercing'}    | ${false}     | ${''}                  | ${''}              | ${true}       | ${1}                    | ${6}                | ${false}         | ${''}                      | ${''}                  | ${'*Ranged Weapon Attack:* mod[dexmod + prof] to hit, range 30/120 ft., one target. *Hit:* dmg[1d6 + dexmod] piercing damage.'}                                                                                                            | ${'<em>Ranged Weapon Attack:</em> +5 to hit, range 30/120 ft., one target. <em>Hit:</em> 6 (1d6 + 3) piercing damage.'}
      ${'Heavy Crossbow'} | ${false}  | ${''}  | ${100}      | ${400}    | ${'piercing'}    | ${false}     | ${''}                  | ${''}              | ${true}       | ${1}                    | ${10}               | ${false}         | ${''}                      | ${''}                  | ${'*Ranged Weapon Attack:* mod[dexmod + prof] to hit, range 100/400 ft., one target. *Hit:* dmg[1d10 + dexmod] piercing damage.'}                                                                                                          | ${'<em>Ranged Weapon Attack:</em> +5 to hit, range 100/400 ft., one target. <em>Hit:</em> 8 (1d10 + 3) piercing damage.'}
      ${'Longbow'}        | ${false}  | ${''}  | ${150}      | ${600}    | ${'piercing'}    | ${false}     | ${''}                  | ${''}              | ${true}       | ${1}                    | ${8}                | ${false}         | ${''}                      | ${''}                  | ${'*Ranged Weapon Attack:* mod[dexmod + prof] to hit, range 150/600 ft., one target. *Hit:* dmg[1d8 + dexmod] piercing damage.'}                                                                                                           | ${'<em>Ranged Weapon Attack:</em> +5 to hit, range 150/600 ft., one target. <em>Hit:</em> 7 (1d8 + 3) piercing damage.'}
    `
