...
describe('should parse valid name expressions', () => {
  const inputText =
    ...
    'Name expressions are parsed even with no whitespace before and/or after them. Some text [NAME]has text immediately after it[NAME] has text immediately before it[NAME]has text immediately before and after it.\n' +
    ...
    'Name expressions begin as sentences if there is no whitespace between the last period and expression.[NAME] begins as a sentence.\n' +
    ...
    'Name expressions are parsed even with no whitespace before and/or after them. Some text [FULLNAME]has text immediately after it[FULLNAME] has text immediately before it[FULLNAME]has text immediately before and after it.\n' +
    ...
    'Name expressions begin as sentences if there is no whitespace between the last period and expression.[FULLNAME] begins as a sentence.\n' +
  ...
  it('when only the full name is defined', () => {
    ...
    const expectedOutputText =
      ...
      'Name expressions are parsed even with no whitespace before and/or after them. Some text the hook horrorhas text immediately after itthe hook horror has text immediately before itthe hook horrorhas text immediately before and after it.\n' +
      ...
      'Name expressions begin as sentences if there is no whitespace between the last period and expression.The hook horror begins as a sentence.\n' +
  ...
  it('when the full name and short name are defined', () => {
    ...
    const expectedOutputText =
      ...
      'Name expressions are parsed even with no whitespace before and/or after them. Some text the dragonhas text immediately after itthe dragon has text immediately before itthe dragonhas text immediately before and after it.\n' +
      ...
      'Name expressions begin as sentences if there is no whitespace between the last period and expression.The dragon begins as a sentence.\n' +
      ...
      'Name expressions are parsed even with no whitespace before and/or after them. Some text the ancient red dragonhas text immediately after itthe ancient red dragon has text immediately before itthe ancient red dragonhas text immediately before and after it.\n' +
      ...
      'Name expressions begin as sentences if there is no whitespace between the last period and expression.The ancient red dragon begins as a sentence.\n' +
  ...
  it('when the full name is defined and it is a proper noun', () => {
    ...
    const expectedOutputText =
      ...
      'Name expressions are parsed even with no whitespace before and/or after them. Some text Tiamathas text immediately after itTiamat has text immediately before itTiamathas text immediately before and after it.\n' +
      ...
      'Name expressions begin as sentences if there is no whitespace between the last period and expression.Tiamat begins as a sentence.\n' +
  ...
  it('when the full name and short name are defined and they are proper nouns', () => {
    ...
    const expectedOutputText =
      ...
      'Name expressions are parsed even with no whitespace before and/or after them. Some text Lady Kimahas text immediately after itLady Kima has text immediately before itLady Kimahas text immediately before and after it.\n' +
      ...
      'Name expressions begin as sentences if there is no whitespace between the last period and expression.Lady Kima begins as a sentence.\n' +
      ...
      'Name expressions are parsed even with no whitespace before and/or after them. Some text Lady Kima of Vordhas text immediately after itLady Kima of Vord has text immediately before itLady Kima of Vordhas text immediately before and after it.\n' +
      ...
      'Name expressions begin as sentences if there is no whitespace between the last period and expression.Lady Kima of Vord begins as a sentence.\n' +
